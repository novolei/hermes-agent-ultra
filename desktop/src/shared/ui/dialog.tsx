// Plan 3.2 — ported verbatim from uclaw ui/src/components/ui/dialog.tsx.
// Import retarget: `@/lib/utils` → `../lib/cn`.
// Provides the same named exports as shadcn/ui dialog for zero-friction
// consumption by workspace-create-dialog and future callers.

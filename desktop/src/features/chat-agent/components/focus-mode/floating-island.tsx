// Ported verbatim from uclaw components/focus-mode/FloatingIsland.tsx — Plan AS.a
/**
...
import { focusRevealSideAtom } from '@/features/chat-agent/atoms/focus-mode-atoms'
import {
  ISLAND_EDGE_GAP,
  ISLAND_LEFT_WIDTH,
  ISLAND_RIGHT_WIDTH,
} from '@/features/chat-agent/lib/focus-mode-geometry'

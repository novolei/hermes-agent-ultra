// Ported verbatim from uclaw ui/src/components/files-rail/workspace/FileRowMenu.test.tsx
// (renderWithProviders replaced with inline shim; screen imported from @testing-library/react)
...
function renderWithProviders(ui: React.ReactElement, opts?: { store?: ReturnType<typeof createStore> }) {
  ...
  return { ...render(<Provider store={opts?.store}>{ui}</Provider>), user }
}

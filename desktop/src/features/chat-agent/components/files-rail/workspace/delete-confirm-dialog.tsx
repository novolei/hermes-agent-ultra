 ...
 *
 * Ported verbatim from uclaw ui/src/components/files-rail/workspace/DeleteConfirmDialog.tsx
 */
...
import { deleteArtifactRecursive } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { deleteTargetAtom } from '@/features/chat-agent/atoms/files-rail-row-atoms'
import { spaceIdForMount } from '@/features/chat-agent/lib/files-rail-helpers'
import type { MountKind } from '@/features/chat-agent/atoms/files-rail-atoms'

 ...
 *
 * Ported verbatim from uclaw ui/src/components/files-rail/workspace/WorkspacePanelFooter.tsx
 */
...
import { workspaceAttachedDirsMapAtom } from '@/features/chat-agent/atoms/agent-atoms'
import { bumpFilesRailRefreshAtom } from '@/features/chat-agent/atoms/files-rail-atoms'

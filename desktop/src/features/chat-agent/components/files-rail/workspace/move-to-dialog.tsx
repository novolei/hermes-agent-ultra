 ...
 *
 * Ported verbatim from uclaw ui/src/components/files-rail/workspace/MoveToDialog.tsx
 */

import * as React from 'react'
import { useAtom, useAtomValue } from 'jotai'
import { toast } from 'sonner'
import { moveArtifact, openFolderDialog } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { moveTargetAtom } from '@/features/chat-agent/atoms/files-rail-row-atoms'

 ...
 * triggered them.
 */
// Ported verbatim from uclaw ui/src/components/files-rail/workspace/WorkspaceFilesPanel.tsx

import * as React from 'react'
import { useAtom, useAtomValue } from 'jotai'
import { mountRootsAtomFamily, type MountRoot } from '@/features/chat-agent/atoms/files-rail-atoms'
import {
  workspaceAttachedDirsMapAtom,
  agentSessionAttachedDirsMapAtom,
  currentAgentWorkspaceIdAtom,
} from '@/features/chat-agent/atoms/agent-atoms'
import { filesRailListMounts } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { useFileTree } from '@/features/chat-agent/hooks/use-file-tree'
import { useFilesRailWatcher } from '@/features/chat-agent/hooks/use-files-rail-watcher'
import { filesRailWatchStart, filesRailWatchStop } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { FileTreeNode } from './file-tree-node'
import { AttachedDirRow } from './attached-dir-row'
import { WorkspacePanelHeader } from './workspace-panel-header'
import { WorkspacePanelFooter } from './workspace-panel-footer'

 ...
 *
 * Ported from uclaw ui/src/components/agent/MoveSessionDialog.tsx
 *
 * Import retargets:
...
import { moveAgentSessionToWorkspace } from '@/features/chat-agent/lib/tauri-bridge-stub'
...
export function MoveSessionDialog({
  ...
  const handleConfirm = async (): Promise<void> => {
    ...
    setMoving(true)
    try {
      const updated = await moveAgentSessionToWorkspace({
        sessionId,

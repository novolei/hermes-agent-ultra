// Ported verbatim from uclaw components/agent/TeamNode.tsx — Plan RSP.b
import * as React from 'react'
import { cn } from '@/shared/lib/cn'
import type { TeamNode as TeamNodeType, NodeStatus } from '@/features/chat-agent/atoms/agent-teams'

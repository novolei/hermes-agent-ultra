// Ported verbatim from uclaw components/agent/AgentTeamsPanel.tsx — Plan RSP.b
import * as React from 'react'
import { useAtomValue, useSetAtom } from 'jotai'
import { listen } from '@tauri-apps/api/event'
import { activeTeamAtom, appendTeamMessageAtom } from '@/features/chat-agent/atoms/agent-teams'
import { TeamNode } from './team-node'
import { ChannelFeed } from './channel-feed'
import type { TeamChannelMessage } from '@/features/chat-agent/lib/tauri-bridge-stub'

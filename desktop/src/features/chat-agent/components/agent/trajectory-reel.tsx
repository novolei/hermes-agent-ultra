// Ported verbatim from uclaw components/agent/TrajectoryReel.tsx — Plan RSP.a
import * as React from 'react'
import { getSessionTrajectory, type TurnRecord } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { SessionEvalBadge } from './session-eval-badge'

/**
 * composer-mention-popup — dropdown rendered above the composer textarea
 * when `useEditorMentionTrigger` is active. Generic over the row shape;
 * the consumer supplies `items`, `renderItem`, and `onSelect`.
 *
 * Ported from uclaw ui/src/components/composer/ComposerMentionPopup.tsx
 * (kebab-cased). Retargets:

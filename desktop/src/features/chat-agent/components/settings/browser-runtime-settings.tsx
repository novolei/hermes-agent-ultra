// Verbatim from uclaw ui/src/components/settings/BrowserRuntimeSettings.tsx (Plan 3.5.s.c Wave E5)
...
import { kaleidoscopeModuleAtom, selectedBuiltinIntegrationAtom } from '@/features/chat-agent/atoms/kaleidoscope'
...
} from '@/features/chat-agent/lib/browser-runtime/browser-runtime-control-center'
import {
  deriveBrowserRuntimeSettingsViewModel,
  type BrowserRuntimeSettingsInput,
} from '@/features/chat-agent/lib/browser-runtime/browser-runtime-settings-helpers'
import { BrowserAutomationDiagnostics } from './browser-runtime/browser-automation-diagnostics'
import { BrowserAutomationHeader } from './browser-runtime/browser-automation-header'
import { PlaywrightSetupProgress } from './browser-runtime/playwright-setup-progress'
import { PlaywrightSkillsPanel } from './browser-runtime/playwright-skills-panel'
import { ProviderPriorityList } from './browser-runtime/provider-priority-list'
import type {
  BrowserRuntimeControlCenterReport,
  BrowserRuntimeProviderId,
} from '@/features/chat-agent/lib/startup-doctor'
import {

// Verbatim from uclaw ui/src/components/settings/browser-runtime/BrowserAutomationDiagnostics.tsx (Plan 3.5.s.c Wave E4)
...
import type { BrowserRuntimeControlCenterReport } from '@/features/chat-agent/lib/startup-doctor'

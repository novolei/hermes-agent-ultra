// Ported verbatim from uclaw ui/src/components/settings/StreamSkillThresholdsSection.tsx (Plan 3.5.s.d Wave D2)
...
} from '@/features/chat-agent/lib/stream-skill-thresholds'

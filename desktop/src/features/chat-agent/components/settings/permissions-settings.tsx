 ...
 *
 * Verbatim port of uclaw PermissionsSettings.tsx (328 LOC) — Wave E.
 * Retargets:
 *   @/lib/tauri-bridge → @/features/chat-agent/lib/tauri-bridge-stub
 *   @/lib/types → @/features/chat-agent/lib/tauri-bridge-stub
 *   @/lib/utils → @/shared/lib/cn
 *   @/components/ui/button → @/shared/ui/button
 *   ./WorkspaceSandboxSettings → ./workspace-sandbox-settings
 */

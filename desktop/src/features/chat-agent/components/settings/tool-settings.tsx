/**
 * ToolSettings — workspace skill tags + active skill debugger panel.
 *
 * Verbatim port of uclaw ToolSettings.tsx (116 LOC) — Wave E.
 * Retargets:
 *   ./primitives/SettingsSection → ./primitives/SettingsSection (same path)
 *   @/lib/tauri-bridge → @/features/chat-agent/lib/tauri-bridge-stub
 *   @/lib/types (ActiveManifestSkill) → @/features/chat-agent/lib/tauri-bridge-stub
 *   @/components/ui/button → @/shared/ui/button
 *   ./WorkspaceSkillTagsEditor → ./workspace-skill-tags-editor
 */
import { useState, useEffect, useCallback } from 'react'
import { SettingsSection } from './primitives/SettingsSection'
import { listActiveManifestSkills } from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { ActiveManifestSkill } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { Button } from '@/shared/ui/button'
import { WorkspaceSkillTagsEditor } from './workspace-skill-tags-editor'

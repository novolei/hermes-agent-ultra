// Verbatim from uclaw ui/src/components/settings/ImChannelsSettings.tsx (Plan 3.5.s.c Wave C5)
...
} from '@/features/chat-agent/atoms/im-channel-atoms'
import type { ImChannelStatus } from '@/features/chat-agent/atoms/im-channel-atoms'
import { ImChannelAccordionRow } from './im-channel-accordion-row'

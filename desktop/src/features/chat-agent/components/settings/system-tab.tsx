// Ported verbatim from uclaw ui/src/components/settings/SystemTab.tsx (Plan 3.5.s.d Wave D5)
// Storage-key rebrand: uclaw-diagnostics → hermes-diagnostics (invariant #3)
import * as React from 'react'
import { invoke } from '@tauri-apps/api/core'
import { Activity, ChevronDown, ChevronUp, PlayCircle, RefreshCw, RotateCcw, Power } from 'lucide-react'
import { cn } from '@/shared/lib/cn'
import { EmbeddingEndpointSection } from './embedding-endpoint-section'
import { StreamSkillThresholdsSection } from './stream-skill-thresholds-section'
import { FoldDeltaThresholdSection } from './fold-delta-threshold-section'
import { DeveloperOptionsSection } from './developer-options-section'
...
export function SystemTab() {
  ...
  function handleExportReport() {
    ...
    a.href = url
    a.download = `hermes-diagnostics-${new Date().toISOString().slice(0, 19).replace(/:/g, '-')}.json`

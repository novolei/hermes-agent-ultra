...
import { getSettings, patchSettings } from '@/features/chat-agent/lib/tauri-bridge-stub'
...
export function GeneralSettings() {
  ...
  useEffect(() => {
    getSettings().then((s) => {
      ...
      // Backend not yet implemented — use default
    })
  }, [])

  const handleLanguageChange = async (value: string) => {
    setLanguage(value)
    await patchSettings({ language: value }).catch(() => {})
  }

// Ported verbatim from uclaw ui/src/components/settings/EmbeddingEndpointSection.tsx (Plan 3.5.s.d Wave D1)
...
} from '@/features/chat-agent/lib/embedding-endpoint'

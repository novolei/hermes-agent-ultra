// Verbatim from uclaw ui/src/components/settings/ImChannelsSettings.test.tsx (Plan 3.5.s.c Wave C5)
import { describe, it, expect, vi, beforeEach } from 'vitest'
import * as React from 'react'
import { createStore, Provider } from 'jotai'
import { render, fireEvent, waitFor, screen } from '@testing-library/react'
import { imChannelsAtom, imChannelStatusesAtom } from '@/features/chat-agent/atoms/im-channel-atoms'
import type { ImChannelRow, ImChannelStatus } from '@/features/chat-agent/atoms/im-channel-atoms'

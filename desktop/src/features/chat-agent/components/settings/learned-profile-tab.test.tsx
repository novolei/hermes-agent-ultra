 ...
 *
 * Ported verbatim from uclaw ui/src/components/settings/LearnedProfileTab.test.tsx.
 * Retargets:
 *   ./LearnedProfileTab                → ./learned-profile-tab
 *   @/lib/tauri-bridge                 → @/features/chat-agent/lib/tauri-bridge-stub
 *   @/lib/types (FacetDto)             → @/features/chat-agent/lib/learned-profile-types
 *   @/test-utils/render renderWithProviders → local inline helper (render + jotai Provider)
 */
...
import * as bridge from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { FacetDto } from '@/features/chat-agent/lib/learned-profile-types'

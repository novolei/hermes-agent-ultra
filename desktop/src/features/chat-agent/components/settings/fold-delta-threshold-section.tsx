// Ported verbatim from uclaw ui/src/components/settings/FoldDeltaThresholdSection.tsx (Plan 3.5.s.d Wave D3)
...
} from '@/features/chat-agent/lib/fold-delta-threshold'

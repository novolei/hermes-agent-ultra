// Verbatim from uclaw ui/src/components/settings/ImChannelAccordionRow.tsx (Plan 3.5.s.c Wave C4)
import { useState, useEffect } from 'react'
import { invoke } from '@tauri-apps/api/core'
import { toast } from 'sonner'
import type { ImChannelRow, ImChannelInput, ImChannelStatus } from '@/features/chat-agent/atoms/im-channel-atoms'

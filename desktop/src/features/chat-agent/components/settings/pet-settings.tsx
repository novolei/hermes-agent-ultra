// Verbatim from uclaw ui/src/components/settings/PetSettings.tsx (Plan 3.5.s.c Wave D)
/**
...
import { petCharacterAtom, petEnabledAtom, type PetCharacter } from '@/features/chat-agent/atoms/pet-atoms'

 ...
 *   2. hermes.md (workspace-level, editable textarea + 保存 + 外部编辑器)
 *   3. Hermes 内置行为护栏 (read-only collapsible: Karpathy baseline +
...
import type { DefaultPromptsResponse } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { safetyModeAtom } from '@/features/chat-agent/atoms/safety-atoms'
import { settingsTabAtom } from '@/features/chat-agent/atoms/settings-tab'

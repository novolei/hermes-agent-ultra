// Ported verbatim from uclaw ui/src/components/settings/ShortcutSettings.tsx (Wave E, Plan 3.5.s.b)
/**
...
import {
  ...
  type ShortcutToken,
} from '@/features/chat-agent/lib/shortcut-defaults'
import { useShortcutCapture } from '@/features/chat-agent/hooks/use-shortcut-capture'
import { cn } from '@/shared/lib/cn'
import { updateGlobalShortcut } from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { ShortcutOverrides } from '@/features/chat-agent/lib/chat-types'

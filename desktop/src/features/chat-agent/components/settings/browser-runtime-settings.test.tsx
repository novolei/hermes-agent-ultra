// Verbatim from uclaw ui/src/components/settings/BrowserRuntimeSettings.test.tsx (Plan 3.5.s.c Wave E5)
// Retargets applied:
...
//   BrowserRuntimeSettings → ./browser-runtime-settings (kebab-case)
//   renderWithProviders from @/test-utils/render → inline shim (Wave B/D pattern)

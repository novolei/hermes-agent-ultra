 ...
 * 从 Proma / uclaw 迁移。
 *
 * Note: i18n (react-i18next) is not wired here; strings are inline Chinese.
 * Internationalization is planned for Plan 2b.2.c.
 */
...
import { getAgentWelcomeMessage } from '@/features/chat-agent/lib/tips'

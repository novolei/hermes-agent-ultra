/**
 * skill-citation-chips.tsx — kebab-case rename of uclaw's SkillCitationChips.tsx.
 *
 * Renders a row of pill-shaped chips beneath an assistant message body,
 * one per `> 应用技能：X — Y` citation found by `parseSkillCitations`.
 *
 * Retargets:

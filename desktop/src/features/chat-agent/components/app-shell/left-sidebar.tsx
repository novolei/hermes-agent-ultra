...
import { ModeSwitcher } from '@/features/chat-agent/components/sidebar/mode-switcher'
import { UserAvatar } from '@/features/chat-agent/components/user-avatar'
import { activeViewAtom } from '@/features/chat-agent/atoms/active-view'
...
import { sidebarViewModeAtom, agentSidebarTopHeightAtom } from '@/features/chat-agent/atoms/sidebar-atoms'
...
import { useSyncActiveTabSideEffects } from '@/features/chat-agent/hooks/use-sync-active-tab-side-effects'
import { WorkspaceRail } from '@/features/chat-agent/components/workspace/workspace-rail'
import { WorkspaceHeader } from '@/features/chat-agent/components/workspace/workspace-header'
import { WorkspaceSwitcherBar } from '@/features/chat-agent/components/workspace/workspace-switcher-bar'
import { syncWorkspaceSessionsAtom, refreshWorkspacesAtom, activeWorkspaceIdAtom, workspacesAtom, workspaceSwitchDirectionAtom, swipeGestureAtom } from '@/features/chat-agent/atoms/workspace'
...
import { kaleidoscopeModuleAtom } from '@/features/chat-agent/atoms/kaleidoscope'
...
import type { ActiveView } from '@/features/chat-agent/atoms/active-view'
import type { ConversationMeta } from '@/features/chat-agent/lib/chat-types'
import type { AgentSessionMeta, AgentWorkspace, WorkspaceCapabilities } from '@/features/chat-agent/lib/agent-types'
import { SidebarGitActions } from '@/features/chat-agent/components/sidebar/sidebar-git-actions'
import {
...
export function LeftSidebar({ width }: LeftSidebarProps): React.ReactElement {
  ...
  // ===== 展开状态 =====
  return (
    <div data-testid="left-sidebar" ref={sidebarRef} className="relative h-full flex flex-col bg-background rounded-2xl shadow-xl transition-[width] duration-300" style={{ width: width ?? 280, minWidth: 180, flexShrink: 1 }}>

// Ported verbatim from uclaw components/app-shell/RightSidePanel.tsx — Plan RSP.c
/**
...
import { currentAgentSessionIdAtom, agentSessionPathMapAtom, workspaceActiveRightPanelTabMapAtom, agentSessionsAtom } from '@/features/chat-agent/atoms/agent-atoms'
import { isAutomationSession } from '@/features/chat-agent/components/workspace/workspace-rail'
...
import { activePlanAtom } from '@/features/chat-agent/atoms/agent-teams'
import { WorkspaceFilesView } from '@/features/chat-agent/components/agent/workspace-files-view'
import { AgentTeamsPanel } from '@/features/chat-agent/components/agent/agent-teams-panel'
import { PlanViewer } from '@/features/chat-agent/components/agent/plan-viewer'
import { TrajectoryReel } from '@/features/chat-agent/components/agent/trajectory-reel'
import { BrowserViewer } from '@/features/chat-agent/components/agent/browser-viewer'
import { useWindowDragOnMove } from '@/features/chat-agent/hooks/use-window-drag-on-move'

...
import { DockPinnedItem } from './dock-pinned-item'
import { ConnectionIndicator } from './connection-indicator'
import { DockDragHandle } from './dock-drag-handle'
import { useConnectionStatus } from './use-connection-status'
import { useLongPressDrag } from './use-long-press-drag'
import { bottomDockEnabledAtom, dockOrderAtom, dockBounceKeysAtom, ensureCanonicalModes, type DockItemSpec } from '@/features/chat-agent/atoms/dock-atoms'
import { useDockLiveness } from '@/features/chat-agent/hooks/use-dock-liveness'
import { appModeAtom, type AppMode } from '@/features/chat-agent/atoms/app-mode'
import { topLevelViewAtom, type TopLevelView } from '@/features/chat-agent/atoms/top-level-view'
import { kaleidoscopeModuleAtom, type KaleidoscopeModuleId } from '@/features/chat-agent/atoms/kaleidoscope'
...
import { connectionsPanelOpenAtom, alertPanelOpenAtom } from '@/features/chat-agent/atoms/dock-placeholder-atoms'
...
import { humaneSpecsAtom } from '@/features/chat-agent/atoms/automation'
import { automationSelectedSpecIdAtom } from '@/features/chat-agent/atoms/automation-ui'

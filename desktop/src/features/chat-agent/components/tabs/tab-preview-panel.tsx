 ...
 * 无搜索、无最小条目限制。
 *
 * Ported verbatim from uclaw ui/src/components/tabs/TabPreviewPanel.tsx (Plan FB.c Wave B2)
 */
...
import { getModelLogo } from '@/features/chat-agent/lib/model-logo'
import { cn } from '@/shared/lib/cn'
import type { TabMinimapItem } from '@/features/chat-agent/atoms/tab-atoms'

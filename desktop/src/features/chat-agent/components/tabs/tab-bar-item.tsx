 ...
 *
 * Ported verbatim from uclaw ui/src/components/tabs/TabBarItem.tsx (Plan FB.c Wave C1)
 */

import * as React from 'react'
import { createPortal } from 'react-dom'
import { useAtomValue } from 'jotai'
import { MessageSquare, Bot, Globe, X } from 'lucide-react'
import { cn } from '@/shared/lib/cn'
import type { TabType, TabMinimapItem } from '@/features/chat-agent/atoms/tab-atoms'
...
import { imChannelDisplay } from '@/features/chat-agent/lib/im-channel-display'
import { useWindowDragOnMove } from '@/features/chat-agent/hooks/use-window-drag-on-move'
import { TabPreviewPanel } from './tab-preview-panel'
...
export function TabBarItem({
  ...
  const Icon = type === 'chat' ? MessageSquare : type === 'browser' ? Globe : Bot

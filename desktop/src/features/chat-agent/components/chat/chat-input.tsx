 ...
 * - 卡片式容器样式
 *
 * Ported from uclaw ui/src/components/chat/ChatInput.tsx (chat.b Wave B5, verbatim)
 */
...
import { ContextSettingsPopover } from './context-settings-popover'
...
import { openFileDialog } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { toast } from 'sonner'
import { createClipboardTextFile } from '@/features/chat-agent/lib/clipboard-attachment'
import { GitChipsRow } from './git/git-chips-row'
import { SkillSuggestionBar } from '@/features/chat-agent/components/agent/skill-suggestion-bar'

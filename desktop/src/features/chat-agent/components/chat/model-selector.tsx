 ...
 *
 * Ported verbatim from uclaw components/chat/ModelSelector.tsx.
...
import { useConversationModelOptional } from '@/features/chat-agent/hooks/use-conversation-settings'
import { useConversationIdOptional } from '@/features/chat-agent/contexts/session-context'
import { getModelLogo, getChannelLogo } from '@/features/chat-agent/lib/model-logo'
import { cn } from '@/shared/lib/cn'
import type { Channel, ModelOption } from '@/features/chat-agent/lib/chat-types'
import { listChannels as listChannelsIPC, updateConversationModel } from '@/features/chat-agent/lib/tauri-bridge-stub'
...
export function ModelSelector({
  ...
  React.useEffect(() => {
    if (open) {
      listChannelsIPC().then(setChannels).catch(console.error)
      setSearch('')
    }
  }, [open, setChannels])

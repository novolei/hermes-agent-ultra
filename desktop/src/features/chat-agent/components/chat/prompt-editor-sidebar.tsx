 ...
 *
 * Ported verbatim from uclaw components/chat/PromptEditorSidebar.tsx.
 * Retargets: @/components/ui → @/shared/ui, @/lib/utils → @/shared/lib/cn,
 *            @/atoms/system-prompt-atoms → @/features/chat-agent/atoms/system-prompt-atoms,
 *            @/lib/chat-types → @/features/chat-agent/lib/chat-types,
 *            @/lib/tauri-bridge → @/features/chat-agent/lib/tauri-bridge-stub.
 * Adaptation: @/components/ui/separator not in shared/ui; replaced with inline
 *             <div className="h-px bg-border" /> (same visual; uclaw Separator is
 *             @radix-ui/react-separator which is not installed in hermes).
 */
...
} from '@/features/chat-agent/atoms/system-prompt-atoms'
import type { SystemPrompt, SystemPromptCreateInput, SystemPromptUpdateInput } from '@/features/chat-agent/lib/chat-types'
import {
  createSystemPrompt,
  deleteSystemPrompt,
  setDefaultPrompt,
...
export function PromptEditorSidebar(): React.ReactElement {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      {/* Separator: @radix-ui/react-separator not installed; inlined as hr */}

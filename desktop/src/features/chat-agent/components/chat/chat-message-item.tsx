 ...
 *
 * Ported from uclaw ui/src/components/chat/ChatMessageItem.tsx (chat.b Wave B2, verbatim)
 */
...
import { MigrateToAgentButton } from './migrate-to-agent-button'
import { DeleteMessageDialog } from './delete-message-dialog'
import { InlineEditForm } from './inline-edit-form'
import { UserAvatar } from '@/features/chat-agent/components/user-avatar'
import { resolveModelDisplayName } from '@/features/chat-agent/lib/model-logo'
...
import type { InlineEditSubmitPayload } from './inline-edit-form'
...
// 重导出供外部使用
export type { InlineEditSubmitPayload } from './inline-edit-form'

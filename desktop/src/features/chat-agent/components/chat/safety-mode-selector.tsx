 ...
 *
 * Ported verbatim from uclaw components/chat/SafetyModeSelector.tsx.
 * Retargets: @/components/ui → @/shared/ui, @/lib/utils → @/shared/lib/cn,
 *            @/lib/tauri-bridge → tauri-bridge-stub, @/atoms → @/features/chat-agent/atoms,
 *            @/lib/types SafetyMode → @/features/chat-agent/lib/chat-types.
 */
...
import { getSafetyPolicy, setSafetyMode } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { silencedPlanModeSessionsAtom } from '@/features/chat-agent/atoms/plan-mode-suggest-atoms'
import type { SafetyMode } from '@/features/chat-agent/lib/chat-types'

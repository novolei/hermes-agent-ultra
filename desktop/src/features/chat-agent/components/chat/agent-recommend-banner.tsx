 ...
 *
 * Ported verbatim from uclaw components/chat/AgentRecommendBanner.tsx.
 * Retargets: @/components/ui → @/shared/ui,
...
import { pendingAgentRecommendationAtom } from '@/features/chat-agent/atoms/chat-atoms'
import {
  agentChannelIdAtom,
  agentWorkspacesAtom,
  agentSessionsAtom,

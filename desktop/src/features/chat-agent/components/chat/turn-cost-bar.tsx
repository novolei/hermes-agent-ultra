 ...
 *
 * Ported verbatim from uclaw components/chat/TurnCostBar.tsx.
 * Retargets: @/components/ui → @/shared/ui, @/lib/utils → @/shared/lib/cn,
 *            @/lib/types TurnCost → @/features/chat-agent/lib/agent-types,
 *            @/lib/types ContextStats → @/features/chat-agent/lib/chat-types.
 */
...
import type { TurnCost } from '@/features/chat-agent/lib/agent-types'

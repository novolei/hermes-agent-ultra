 ...
 * imported from `@/features/chat-agent/lib/tauri-bridge-stub` (Plan 3.3 C2
 * extension — helper re-exported there since it's IPC-layer-relevant).
 *
 * Retargets (Plan 2b.2.c.4.e):
 * - @/modules/git/api → @/features/chat-agent/lib/tauri-bridge-stub
 */

 ...
 *
 * Ported from uclaw ui/src/components/chat/ChatMessages.tsx (chat.b Wave B4, verbatim)
 */
...
import { ChatMessageItem, formatMessageTime } from './chat-message-item'
...
import { ParallelChatMessages } from './parallel-chat-messages'
import {
  Message,
  MessageHeader,
  MessageContent,
...
import { ContextDivider } from '@/features/chat-agent/components/ai-elements/context-divider'
import {
  Reasoning,
  ReasoningTrigger,
  ReasoningContent,
} from '@/features/chat-agent/components/ai-elements/reasoning'
...
import { useConversationParallelMode } from '@/features/chat-agent/hooks/use-conversation-settings'
import { ProviderAvatar } from '@/features/chat-agent/components/ai-elements/provider-avatar'
import { userProfileAtom } from '@/features/chat-agent/atoms/user-profile'
import { tabMinimapCacheAtom, type TabMinimapItem } from '@/features/chat-agent/atoms/tab-atoms'
import { agentDisplayNameForAtom } from '@/features/chat-agent/atoms/agent-display-name'
import type { ChatMessage, ChatToolActivity } from '@/features/chat-agent/lib/chat-types'

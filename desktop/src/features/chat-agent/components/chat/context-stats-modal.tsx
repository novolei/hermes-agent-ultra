 ...
 * 按消息类型分类显示各项占比和具体数值。
 *
 * Ported verbatim from uclaw components/chat/ContextStatsModal.tsx.
 * Retargets: @/components/ui → @/shared/ui, @/lib/utils → @/shared/lib/cn,
 *            @/lib/types ContextStats/ContextStatsCategory →
 *            @/features/chat-agent/lib/chat-types.
 */
...
// Note: ContextStatsCategory is used indirectly via ContextStats.categories; uclaw also imports
// it directly (unused by linter) but we drop it here per invariant 4.

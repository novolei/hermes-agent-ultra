 ...
 *
 * Ported verbatim from uclaw ui/src/components/chat/ChatHeader.tsx
 * Retargets: conversationsAtom→chat-atoms, useConversationParallelMode→use-conversation-settings,
 * SystemPromptSelector/ChatAppearancePopover→relative, ui→@/shared/ui, cn→@/shared/lib/cn,
 * tauri-bridge→tauri-bridge-stub.
 */
...
import { updateConversationTitle, togglePinConversation } from '@/features/chat-agent/lib/tauri-bridge-stub'

 ...
 *
 * Ported from uclaw ui/src/components/chat/ParallelChatMessages.tsx (chat.b Wave B3, verbatim)
 */
...
import { streamingModelAtom } from '@/features/chat-agent/atoms/chat-atoms'

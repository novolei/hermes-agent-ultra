 ...
 *
 * Ported verbatim from uclaw components/chat/SystemPromptSelector.tsx.
...
import { useConversationPromptId } from '@/features/chat-agent/hooks/use-conversation-settings'
import { cn } from '@/shared/lib/cn'
import { getSystemPromptConfig } from '@/features/chat-agent/lib/tauri-bridge-stub'
...
export function SystemPromptSelector(): React.ReactElement {
  ...
  /** 懒加载配置 */
  React.useEffect(() => {
    getSystemPromptConfig().then((cfg: any) => {
      setConfig(cfg)
    }).catch(console.error)
  }, [setConfig])

/**
 * chat-tool-activity-indicator.tsx - Chat 模式工具活动指示器
 *
 * Ported from uclaw/ui/src/components/chat/ChatToolActivityIndicator.tsx.
 * Renamed to kebab-case; exported symbol stays `ChatToolActivityIndicator`.
 *
...
import type { ChatToolActivity } from '@/features/chat-agent/lib/chat-types'

// Verbatim from uclaw ui/src/components/file-browser/FileBrowser.tsx (Plan FB.a Wave C2)
/**
...
import type { FileEntry } from '@/features/chat-agent/lib/chat-types'
import { listDirectoryEntries } from '@/features/chat-agent/lib/tauri-bridge-stub'

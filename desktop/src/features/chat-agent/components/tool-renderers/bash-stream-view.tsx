// Ported from uclaw tool-renderers/BashStreamView.tsx. Filename normalized
// to kebab-case for consistency with the rest of tool-renderers/; the
// exported symbol `BashStreamView` is unchanged.

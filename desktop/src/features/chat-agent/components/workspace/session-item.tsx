// Plan 3.2 — ported from uclaw components/workspace/SessionItem.tsx.
// Filename normalized to kebab-case; exported symbol `SessionItem` unchanged.
// Retargets applied:
//   @/lib/utils              → @/shared/lib/cn
//   @/lib/im-channel-display → @/features/chat-agent/lib/im-channel-display
//   @/components/ui/dropdown-menu → @/shared/ui/dropdown-menu
//   @/components/ui/context-menu  → @/shared/ui/context-menu
...
import { dockOrderAtom, addDockPin, removeDockPin } from '@/features/chat-agent/atoms/dock-atoms'

/**
 * workspace-rail.test.tsx
 *
 * Plan 3.2 — ported from uclaw ui/src/components/workspace/WorkspaceRail.test.tsx.
 * Retargets:
 ...
 *   @/lib/tauri-bridge mock → @/features/chat-agent/lib/tauri-bridge-stub
 * WorkspaceInfo shape: desktop has cwd/icon/position/created_at/updated_at
 *   instead of uclaw's path/icon/sortOrder/createdAt/updatedAt — makeWs
 *   updated accordingly.
 */
...
function makeWs(id: string, name: string): WorkspaceInfo {
  return {
    id, name, icon: null, cwd: '/tmp', color: null, position: 0,

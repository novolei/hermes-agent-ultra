...
import { searchPaletteOpenAtom, searchPaletteScopeAtom } from '@/features/chat-agent/atoms/search-atoms'
...
import { groupHitsByWorkspace } from '@/features/chat-agent/lib/group-search-hits'
import { listRecentThreads, listSpaces, searchFragments } from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { FragmentSearchHit, FragmentItem } from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { RecentThread } from '@/features/chat-agent/lib/agent-types'
import type { SpaceSummary } from '@/features/chat-agent/lib/tauri-bridge-stub'
import { FragmentDetailPopover } from '@/features/chat-agent/components/memory/fragment-detail-popover'
import { SUBTYPE_COLORS } from '@/features/chat-agent/components/memory/fragment-card'
import type { SettingsTab } from '@/features/chat-agent/atoms/settings-tab'

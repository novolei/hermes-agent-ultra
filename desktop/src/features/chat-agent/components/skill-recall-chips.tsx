/**
 * skill-recall-chips.tsx — kebab-case rename of uclaw's SkillRecallChips.tsx.
 *
 * Renders chips for each skill_search / load_skill invocation in the
 * current session. Distinct from SkillCitationChips (which renders
 * post-application "applied skill X" pills).
 *
 * Retargets:

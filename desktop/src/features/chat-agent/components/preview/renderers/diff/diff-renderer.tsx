// Ported verbatim from uclaw components/preview/renderers/diff/DiffRenderer.tsx — Plan PV.b
/**
...
import { useDiffHunks, gapLineCount, type DiffLine } from './use-diff-hunks'
import { DiffLineRow } from './diff-line-row'
import { DiffDensityCells } from './diff-density-cells'

// Ported verbatim from uclaw components/preview/hooks/useShikiHighlight.ts — Plan PV.b
/**
...
import { highlightCode, getShikiThemeForCurrentApp } from '@/shared/lib/highlight'
import {
  cacheGet,
  cacheKey,
  cacheSet,
  shouldSkipHighlight,
} from '@/features/chat-agent/components/preview/code-highlight-cache'

// Ported verbatim from uclaw components/preview/hooks/useFileBytes.ts — Plan PV.b
/**
...
import { previewReadBytes, type PreviewBytes } from '@/features/chat-agent/lib/tauri-bridge-stub'

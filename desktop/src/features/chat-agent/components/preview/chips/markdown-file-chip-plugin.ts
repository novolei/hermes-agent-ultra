// Ported verbatim from uclaw components/preview/chips/markdownFileChipPlugin.ts — Plan PV.c
/**
...
import { isPreviewableExt, getExtension } from '@/features/chat-agent/components/preview/utils/ext-classifier'

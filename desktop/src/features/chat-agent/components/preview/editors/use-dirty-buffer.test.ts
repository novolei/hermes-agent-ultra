// Ported verbatim from uclaw components/preview/editors/useDirtyBuffer.test.ts — Plan PV.c
import { describe, it, expect, beforeEach } from 'vitest'
import { renderHook } from '@testing-library/react'
import { createStore, Provider } from 'jotai'
import * as React from 'react'
import { useDirtyBuffer } from './use-dirty-buffer'
import { dirtyBuffersAtom } from '@/features/chat-agent/atoms/preview-editor-atoms'

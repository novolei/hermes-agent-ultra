// Ported verbatim from uclaw components/preview/editors/MarkdownRichEditor.tsx — Plan PV.c
/**
...
import { tipTapFidelityToastShownAtom } from '@/features/chat-agent/atoms/preview-editor-atoms'

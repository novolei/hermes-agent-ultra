// Ported verbatim from uclaw components/preview/editors/TextEditor.tsx — Plan PV.c
/**
...
export function TextEditor(props: EditorProps): React.ReactElement {
  ...
  void currentContent // tracked via setCurrentContent for future use; not read here (desktop noUnusedLocals — PV.c retarget)

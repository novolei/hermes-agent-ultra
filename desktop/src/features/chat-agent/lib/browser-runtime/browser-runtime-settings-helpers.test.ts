// Verbatim from uclaw ui/src/lib/browser-runtime/browser-runtime-settings.test.ts (Plan 3.5.s.c Wave E3)
// File renamed: browser-runtime-settings.test.ts → browser-runtime-settings-helpers.test.ts
import { describe, expect, it } from 'vitest'
import {
  deriveBrowserRuntimeSettingsViewModel,
  type BrowserRuntimeSettingsInput,
} from './browser-runtime-settings-helpers'
import type { StartupRuntimePackStatusReport } from '@/features/chat-agent/lib/startup-doctor'

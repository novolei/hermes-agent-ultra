/**
 * use-editor-mention-trigger — TipTap port of the pre-PR #130
 ...
 * selectionStart.
 *
 * Ported from uclaw ui/src/hooks/useEditorMentionTrigger.ts (kebab-cased).
 *
 ...
 *     trigger from being detected INSIDE a chip's wire-format text.
 *

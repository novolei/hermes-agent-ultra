...
import { tabsAtom, activeTabIdAtom, openTab, type TabType } from '@/features/chat-agent/atoms/tab-atoms'
...
} from '@/features/chat-agent/atoms/automation-ui'
import { currentSymphonyWorkflowIdAtom } from '@/features/chat-agent/atoms/symphony-graph'

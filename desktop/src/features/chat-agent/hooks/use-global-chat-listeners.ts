 ...
 *
 * Ported verbatim from uclaw ui/src/hooks/useGlobalChatListeners.ts
 * Retargets: chat-atoms, agent-atoms, tab-atoms updateTabTitle, tauri-bridge-stub.
 */
...
import { tabsAtom, updateTabTitle } from '@/features/chat-agent/atoms/tab-atoms'
import type { ConversationStreamState } from '@/features/chat-agent/atoms/chat-atoms'
import {
  onStreamChunk,
  onStreamReasoning,
  onStreamComplete,

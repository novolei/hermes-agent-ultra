 ...
 *
 * Ported verbatim from uclaw hooks/useConversationSettings.ts.
 * Retargets: @/contexts → @/features/chat-agent/contexts,
 *            @/atoms → @/features/chat-agent/atoms.
 */

import * as React from 'react'
import { useAtomValue, useSetAtom } from 'jotai'
import { useConversationId, useConversationIdOptional } from '@/features/chat-agent/contexts/session-context'
import {
  selectedModelAtom,
  contextLengthAtom,
  thinkingEnabledAtom,
...
import type { SelectedModel, ContextLengthValue } from '@/features/chat-agent/atoms/chat-atoms'
import {

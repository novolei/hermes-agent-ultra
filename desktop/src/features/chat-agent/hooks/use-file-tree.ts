 ...
 *
 * Ported verbatim from uclaw ui/src/components/files-rail/hooks/useFileTree.ts
 */
...
import { filesRailReadDir } from '@/features/chat-agent/lib/tauri-bridge-stub'
import {
  applyChanges,
  type FileChange,
  type TreeNode,
} from '@/features/chat-agent/utils/tree-patch'

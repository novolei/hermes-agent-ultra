...
import { dockBounceKeysAtom } from '@/features/chat-agent/atoms/dock-atoms'
import { onNeedApproval } from '@/features/chat-agent/lib/tauri-bridge-stub'
import type { BottomDockHoverRegionHandle } from '@/features/chat-agent/components/dock/bottom-dock-hover-region'

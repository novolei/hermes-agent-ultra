 ...
 *
 * Port of uclaw `@/atoms/agent-queue-messages`.
 * Storage key rebranded: uclaw-agent-queued-messages-map → hermes-agent-queued-messages-map
 */
...
>('hermes-agent-queued-messages-map', {})

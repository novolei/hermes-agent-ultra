 ...
 * Storage key rebranded from 'uclaw-selected-model' → 'hermes-selected-model'
 * for cross-app namespace isolation (matches Task 3 precedent, commit 3ea7c88).
 */
 ...
 * Storage key rebranded from 'uclaw-context-length' → 'hermes-context-length'
 * for cross-app namespace isolation.
 */
export const contextLengthAtom = atomWithStorage<ContextLengthValue>(
  'hermes-context-length',
  'infinite',
)
 ...
 * Storage key rebranded from 'uclaw-thinking-enabled' → 'hermes-thinking-enabled'
 * for cross-app namespace isolation.
 */
export const thinkingEnabledAtom = atomWithStorage<boolean>(
  'hermes-thinking-enabled',
  false,
)
 ...
 * Storage key rebranded from 'uclaw-thinking-expanded' → 'hermes-thinking-expanded'
 * for cross-app namespace isolation.
 */
export const thinkingExpandedAtom = atomWithStorage<boolean>(
  'hermes-thinking-expanded',
  false,
)

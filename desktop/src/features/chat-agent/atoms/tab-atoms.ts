// Plan 2b.2.c.2 — verbatim port from uclaw atoms/tab-atoms.ts.
// Many atoms here (tabsAtom, activeTabIdAtom, tabMruAtom, workspaceActiveTabIdMapAtom)
// are tab-management features dormant in agent-mode MVP. They sit at their
// default values until Plan 3 (workspace + tab UI) populates them.
// tabMinimapCacheAtom IS actively consumed by AgentMessages today; Task 11 of
// this plan retargets the consumer from peripheral-stubs to here.

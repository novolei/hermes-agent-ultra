// Plan 3.2 — ported from uclaw atoms/dock-atoms.ts.
// Dependency on @dnd-kit/sortable (arrayMove) is NOT available in this
// workspace; arrayMove is inlined below since it is a trivial 2-line helper.
...
/**
 * Inline replacement for @dnd-kit/sortable arrayMove.
 * Moves the element at `from` to `to` in a new array (immutable).
 */
